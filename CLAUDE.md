...
- 21 skills have real lesson content (up from the original Python-only
  ...
  Feature Engineering, Financial Markets (all complete), Quant Finance
  Fundamentals (5/9). The rest of the technology catalog is
  metadata-only (by design — see `docs/COURSE_CONTENT_SPEC.md`). Monte
  Carlo and
